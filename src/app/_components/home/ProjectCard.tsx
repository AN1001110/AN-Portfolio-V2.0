...
export default function ProjectCard({
  ...
  return (
    <Link
      href={link}
      className="border-border bg-card dark:bg-card-dark dark:border-border-dark dark:bg-card-background-dark dark:shadow-card-foreground-dark/10 shadow-card-foreground/10 flex flex-col gap-4 rounded-lg border transition-transform duration-300 hover:scale-105 hover:shadow-sm"
    >
